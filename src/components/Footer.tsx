        ...
        <div className="footer-bottom-content">
          ...
          <div className="social-links">
            {currentConfig.socialMedia?.instagram && (
              <a 
                href={`https://instagram.com/${currentConfig.socialMedia.instagram.replace('@', '')}`} 
                target="_blank" 
              ...
              >
                ...
                {currentConfig.socialMedia.instagram.replace('@', '')}
              </a>
            )}
            {currentConfig.socialMedia?.facebook && (
              <a 
                href={`https://facebook.com/${currentConfig.socialMedia.facebook}`} 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-link"
              >
            ...
            {currentConfig.socialMedia?.twitter && (
              <a 
                href={`https://twitter.com/${currentConfig.socialMedia.twitter.replace('@', '')}`} 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-link"
              >
